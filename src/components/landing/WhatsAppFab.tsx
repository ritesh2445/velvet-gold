...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full flex items-center justify-center shadow-2xl transition-all ${
        show ? "animate-pop-in" : "opacity-0 scale-0"
      }`}
