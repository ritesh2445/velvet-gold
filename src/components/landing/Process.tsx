  ...
  return (
    <section className="py-28 lg:py-40 border-t border-border">
      <div className="mx-auto max-w-[1500px] px-6 lg:px-10">
        <div className="grid lg:grid-cols-[40%_60%] gap-12 items-end mb-20">
          <div>
            <Reveal>
              <p className="eyebrow">The Process</p>
            </Reveal>
            <Reveal delay={100}>
              <h2 className="mt-8 display text-[clamp(2.5rem,6vw,5rem)]">
                From Hello
                <br />
          ...
          {steps.map((s, i) => (
            <Reveal key={s.n} delay={i * 100}>
              <div className="bg-background p-10 h-full">
                <div className="display text-7xl text-amber/30">{s.n}</div>
                <h3 className="mt-8 display text-2xl">{s.t}</h3>
